    ...
    <div class="area-zone bg">
        ...
        <div class="pag">
            <div class="inside_pag">
                <div class="bullet arabicNumbers" style="opacity: 1">6</div>
        ...
        <div class="navPlace">
            <div class="rightItem">
                <div class="l">
                    <img id="pullAR" class="img-responsive" src="../images/Plac_Test_58.png" />
                </div>
                <div class="r">
                    <h2 class="text-center arabicNumbers">7</h2>
                </div>
            </div>
        </div>
        <img src="../images/Plac_Test_59.png" style="margin-right: 8%;margin-top: 41px;" />
        <img src="../images/Plac_Test_38.png" style="margin-right: 27%;margin-top: 30px;" />
        <div class="Choices2" style="margin-top: 2%;margin-right: 15%;">
            <img src="../images/Plac_Test_60.png" style="display:inline-block" id="1" class="choiceClick" />
            <img src="../images/Plac_Test_61.png" style="display: inline-block; margin-right: 5%;" id="2" class="choiceClick correctChoice" />
            <img src="../images/Plac_Test_133.png" style="display: inline-block;margin-right: 5%;" id="3" class="choiceClick" />
