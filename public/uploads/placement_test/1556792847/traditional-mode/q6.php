    ...
    <div class="area-zone bg">
        ...
        <div class="pag">
            <div class="inside_pag">
                <div class="bullet arabicNumbers" style="opacity: 1">5</div>
        ...
        <div class="navPlace">
            <div class="rightItem">
                ...
                <div class="r">
                    <h2 class="text-center arabicNumbers">6</h2>
                </div>
            </div>
        </div>
        <div id="mp3Player">
            <div id="mp3PlayerProgressBar" class="slider-green">
                <div id="slider">
            ...
            <div id="mp3PlayerButtons">
                <a onclick="bntMp3Stop();">
                    <img src="../images/Plac_Test_52.png" />
                </a>
                <a onclick="bntMp3Play();">
                    <img src="../images/Plac_Test_51.png" style="margin-left: 20px; margin-right: 20px" />
                </a>
                <a onclick="bntMp3Pause();">
                    <img src="../images/Plac_Test_53.png" />
                </a>
            </div>
        </div>
        <img src="../images/Plac_Test_132.png" style="margin-right: 27%;margin-top: -41px;" />
        <div class="Choices2" style="margin-top: 4%;margin-right: 10%;">
            <img src="../images/Plac_Test_54.png" style="display:inline-block" id="1" class="choiceClick correctChoice" />
            <img src="../images/Plac_Test_55.png" style="display: inline-block; margin-right: 6%;" id="2" class="choiceClick" />
            <img src="../images/Plac_Test_56.png" style="display: inline-block;margin-top: 43px;" id="3" class="choiceClick" />
            <img src="../images/Plac_Test_57.png" style="display: inline-block;margin-right: 6%;margin-top: 43px;" id="4" class="choiceClick" />
        </div>
    </div>
...
<!--    <script src="../js/jquery-3.1.1.min.js"></script>-->  
    ...
    <script>
        var soundSrc = '../media/Place_Test_Sound_03.mp3';
    </script>
