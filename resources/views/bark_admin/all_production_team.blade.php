                                            ...
                                            <div class="table-responsive" style="overflow-x:initial;">
                                                <table id="zero-configuration" class="display table nowrap table-striped table-hover" style="width:100%">
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            <td> doaa abdallah</td>
                                                            <td>doaa.kalemon@gmail.com</td>
                                                            <td>admin</td>
                                                            <td>2</td>
                                                            <td>2-2-2012 </td>
                                                            <td>2-2-2012 </td>
                                                            <td>
                                                        <button type="button" class="btn btn-danger" style=" float: left;" title="btn btn-danger" data-toggle="tooltip">حذف</button>
                                                        <button type="button" class="btn btn-success" style=" float: left;" title="btn btn-success" data-toggle="tooltip"><a href="edit.html" class="" style="color: ivory">تعديل</a></button>
                                                            </td>
                                                        </tr>
                                                    </tbody>
                                                      ...
                                                      <form>
                                                        <label class="checkbox-inline">
                                                          <input type="checkbox" value=""> مدخل بيانات
                                                        </label>
                                                        <label class="checkbox-inline">
                                                          <input type="checkbox" value=""> ادمن 
                                                        </label>
                                                      </form>       
                                            </div>
                                        </div>
