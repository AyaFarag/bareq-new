                                        ...
                                        <div class="card-block">
                                            <div class="table-responsive" style="overflow-x:initial;">
                                                <table id="zero-configuration" class="display table nowrap table-striped table-hover" style="width:100%">
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            <td> <a href="unit_show.html" class="" style="color: lightslategray"> الدرس الاول </a>  </td>
                                                            <!-- <td> 3</td> -->
                                                            <td>
                                                        <button type="button" class="btn btn-danger" style=" float: left;" title="btn btn-danger" data-toggle="tooltip">حذف الدرس</button>
                                                        <!-- <button type="button" class="btn btn-success" style=" float: left;" title="btn btn-success" data-toggle="tooltip"><a href="add_actitvity.html" class="" style="color: ivory">اضافه نشاط</a></button> -->
                                                        <button type="button" class="btn btn-success" style=" float: left;" title="btn btn-success" data-toggle="tooltip"><a href="edit_lesson.html" class="" style="color: ivory">تعديل الدرس</a></button>
                                                            </td>
                                                        </tr>
                                                    </tbody>
                                                    
                                                </table>
                                                <button type="button" class="btn btn-success" style=" float: left;" title="btn btn-success" data-toggle="tooltip"><a href="add_lesson.html" class="" style="color: ivory">اضافه درس</a></button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
