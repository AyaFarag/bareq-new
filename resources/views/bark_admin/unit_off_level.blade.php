                                        ...
                                        <div class="card-block">
                                            <div class="table-responsive" style="overflow-x:initial;">
                                                <table id="zero-configuration" class="display table nowrap table-striped table-hover" style="width:100%">
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            <td> <a href="unit_show.html" class="" style="color: lightslategray">الوحده الاول </a>  </td>
                                                            <td> 3</td>
                                                            <td>
                                                        <button type="button" class="btn btn-danger" style=" float: left;" title="btn btn-danger" data-toggle="tooltip">حذف الوحده</button>
                                                        ...
                                                        <button type="button" class="btn btn-success" style=" float: left;" title="btn btn-success" data-toggle="tooltip"><a href="edit_uint.html" class="" style="color: ivory">تعديل الوحده</a></button>
                                                            </td>
                                                        </tr>
                                                    </tbody>
                                                    
                                                </table>
                                                <button type="button" class="btn btn-success" style=" float: left;" title="btn btn-success" data-toggle="tooltip"><a href="add_uint.html" class="" style="color: ivory">اضافه وحده</a></button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
